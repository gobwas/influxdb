...
// parseCreateSubscriptionStatement parses a string and returns a SubscribeStatement.
...
// parseDropSubscriptionStatement parses a string and returns a SubscribeStatement.
